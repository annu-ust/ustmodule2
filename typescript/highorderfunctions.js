...
console.log("years played");
console.log(yearsPlayed);
var newScores1 = scores.map(function (score) {
    return (score * 2);
});
console.log("new score with arrow operator");
console.log(newScores1);
//4.sort
var sortedScores = scores.sort(function (score1, score2) {
    if (score1 > score2) { //ascending order
        return 1;
    }
    else {
        return -1;
...
var sortedScores1 = scores.sort(function (score1, score2) {
    if (score1 > score2) { //decending order
        return -1;
    }
    else {
        return 1;
